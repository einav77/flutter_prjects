...
class Lobby:
    ...
    def main(self):
        ...
        chess_image = Image.open(r'../images/icons/chess.png')
        ...
        checkers_image = Image.open(r'../images/icons/checkers.png')
        ...
        tic_tac_toe_image = Image.open(r'../images/icons/tic-tac-toe.png')
        ...
        connect_four_image = Image.open(r'../images/icons/four_row.png')
