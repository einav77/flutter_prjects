...
from tic_tac_toe.network import Network
...
class Client:
    ...
    def __init__(self, username):
        ...
        p.display.set_caption(self.username + "'s tic tac toe")
    ...
    def draw_lobby(self):
        ...
        label_pos = (440 - label.get_width(), 300 - label.get_height())
            ...
            for e in p.event.get():
                ...
                if game.game_over is False:
                    if game.ready_to_start is True:
                        if player.mark == game.curr_player:
                        ...
                        if e.type == p.MOUSEBUTTONDOWN and player.your_turn is True:
                            ...
                            if Board.is_in_boundaries(row, col) and board.is_valid_move(
